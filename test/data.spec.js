...
describe('Prueba para la función sortAsc', () => {
  ...
  it('Debería retornar a la data ordenada por año en forma ascendente', () => {
    expect(ordenarAsc(dataPrueba)).toEqual(peliculaCastle, peliculaTotoro, peliculaGrave, peliculaKiki, peliculaOnly);
  });
});
...
describe('Prueba para la función sortDesc', () => {
  ...
  it('Debería retornar a la data ordenada por año en forma ascendente', () => {
    expect(ordenarDesc(dataPrueba)).toEqual(peliculaOnly, peliculaKiki, peliculaGrave, peliculaTotoro, peliculaCastle);
  });
});
