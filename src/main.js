import { filtro, obtenerDatos, orderAZ, calcularPorcentaje, calcularPorcentajeEscuelas} from './data.js';
...
btnGrif.addEventListener('click', () => {
  const { porcentajeMujeres, porcentajeHombres } = calcularPorcentajeEscuelas(datos);
  console.log(calcularPorcentaje(datos));
  spanPorcentajeHombres.innerHTML = porcentajeHombres + "%";
  spanPorcentajeMujeres.innerHTML = porcentajeMujeres + "%";
  console.log("Hola!")
